...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SyncEntry'
        db.create_table(u'cartodbsync_syncentry', (
        ...
        db.send_create_signal(u'cartodbsync', ['SyncEntry'])


    def backwards(self, orm):
        # Deleting model 'SyncEntry'
        db.delete_table(u'cartodbsync_syncentry')


    models = {
        u'cartodbsync.syncentry': {
            'Meta': {'object_name': 'SyncEntry'},
